//
// child/webpack.config.js
// output.publicPath: '/workspace-rolodex-dist/'
// devServer.static.publicPath: '/workspace-rolodex-dist/'
// devServer.port: 9001
// devServer.proxy.target: 'http://localhost:5001'
// 
...
module.exports = {
  ...
  output: {
    ...
    publicPath: '/workspace-rolodex-dist/',  // Update this to match your repository name
  },
  plugins: [
